...
- 周三（核对日，疲惫期）：
  ① 核对清单台账与数据报表，盯屏幕眼酸，茶水间接水活动颈椎，工位摸鱼
  ② 月中盘点对账，下午犯困，看招聘新岗位，整理异常单
  ③ 整理报表数据，核对考勤，去洗手间洗把脸，刷面试通知
  ④ 主管让复核上周数据，Excel筛选，眼睛累，和同事借眼药水
  ⑤ 录入库存数据，核对差异，下午茶水间，摸鱼等下班
  ⑥ 核对客户信息，整理异常单，闭目几分钟，投简历
- 周四（汇总日，盼周末）：
